    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("14. Search For Patient by Id");
                Console.WriteLine("15. Search For Doctor by Id");
                ...
                try
                {
                    switch (choice)
                    {
                        case "1":
                            ...
                            int newAppointmentId = clinicManager.AddAppointment(patientID, doctorID, dateTime);
                        ...
                        case "4":
                            ...
                            Console.WriteLine("2. Patient ID");
                            ...
                            if (searchChoice == "1")
                            {
                                ...
                                {
                                    var appointments = clinicManager.SearchAppointmentsByDoctor(doctorId);
                            ...
                            else if (searchChoice == "2")
                            {
                                ...
                                {
                                    var appointments = clinicManager.SearchAppointmentsByPatient(PatientId);
                                    if (appointments.Count == 0)
                        ...
                        case "10":
                            ...
                            if (patients.Count == 0)
                                ...
                                foreach (var p in patients)
                                    Console.WriteLine($"Patient ID: {p.PatientId}, Name: {p.Name}");
                            break;
                        ...
                        case "14":
                            Console.Write("Enter patient ID: ");
                            int searchPatientId = int.Parse(Console.ReadLine());
                            var patient = clinicManager.SearchPatientById(searchPatientId);
                            if (patient != null)
                                Console.WriteLine($"Patient ID: {patient.PatientId}, Name: {patient.Name}, Phone: {patient.Phone}, Email: {patient.Email}");
                            else
                        ...
                        case "15":
                            ...
                            var doctor = clinicManager.SearchDoctorById(searchDoctorId);
                            if (doctor != null)
                                Console.WriteLine($"Doctor ID: {doctor.DoctorId}, Name: {doctor.Name}, Phone: {doctor.Phone}, Email: {doctor.Email}, Specialty: {doctor.Specialty}");
                            else
